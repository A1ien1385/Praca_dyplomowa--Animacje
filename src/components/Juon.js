...
export default function Juon() {
  ...
  useEffect(()=> {
    ...
    const ACTIVE_FRONT_Cloud = elements.getElementById('ACTIVE_x5F_CLOUD_x5F_FRONT');
    const ACTIVE_BACK_CLOUD = elements.getElementById('ACTIVE_x5F_CLOUD_x5F_BACK');
    ...
    const tl = gsap.timeline({defaults: {ease: "power3.inout"}});
      ...
      TweenMax.fromTo(ACTIVE_KAYAKOSAEKI_WALKING, {x:'+=0', autoAlpha: .5, ease: "power1.inOut"}, {duration: 8, x: '-=200', y: '+=90', autoAlpha: 0, repeat: -1, repeatDelay: 10});
      ...
      TweenMax.fromTo(ACTIVE_KAYAKOFACE, {x: '-=500', scale: 1.2}, {duration: 2, autoAlpha: 1, delay: 6, x: '0', repeat: -1, repeatDelay: 2, yoyo: true});
      gsap.to(ACTIVE_KAYAKOSAEKI_WALKING, {duration: .6, rotation: 5, transformOrigin: '50% 50%', repeat: -1, yoyo: true});
      gsap.fromTo(ToshioHeadBack, {rotation: 15}, {duration: 4, rotation: -15,  ease: "power1.inOut", transformOrigin: '50% 50%', repeat: -1, yoyo: true});
      gsap.fromTo(ACTIVE_TOSHIOHEAD_FRONT, {rotation: -15}, {duration: 4, rotation: 15, ease: "power1.inOut", transformOrigin: '50% 10%', repeat: -1, yoyo: true});
      gsap.to(ACTIVE_FRONT_Cloud, {duration: 17, x: '+=250', y: '-50', ease: "power1.inOut", repeat: -1, yoyo: true, scale: 1.2, autoAlpha: .8});
      gsap.to(ACTIVE_BACK_CLOUD, {duration: 17, y: '+=50', x: '-50', ease: "power1.inOut", repeat: -1, yoyo: true, scale: 1.4, autoAlpha: .8});
